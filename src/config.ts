...
function getDefaultCloudsConfig(): CloudsConfig {
    return {
        level: DEFAULT_CLOUDS_LEVEL,
        scale: DEFAULT_CLOUDS_SCALE,
    }
}
...
function getOctavesConfig(): OctavesConfig {
    return {
        count: DEFAULT_OCTAVES_COUNT,
        persistence: DEFAULT_OCTAVES_PERSISTENCE,
        lacunarity: DEFAULT_OCTAVES_LACUNARITY, 
    }
}
