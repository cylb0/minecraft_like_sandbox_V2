...
function getDefaultLightingConfig(): LightingConfig {
    return {
        ...
        sunLight: {
            ...
            radius: Math.max(DEFAULT_RENDER_RADIUS * DEFAULT_CHUNK_DIMENSIONS.width * 2, DEFAULT_CHUNK_DIMENSIONS.depth * 1.5),
            shadow: {
                frustum: Math.max(DEFAULT_RENDER_RADIUS * DEFAULT_CHUNK_DIMENSIONS.width * 2, DEFAULT_CHUNK_DIMENSIONS.depth * 1.5),
